...
import "../styles/donateelecwaste.css";
import { addDonation } from "../api"; // import API helper

export default function DonateElectronicWaste() {
  ...
  const handleDonation = async (e) => {
    ...
    try {
      ...
      alert("Electronic Waste donation submitted successfully!");
